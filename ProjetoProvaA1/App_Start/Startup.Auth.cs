    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "2262255014138990",
               appSecret: "8c99c013e7124c1f2972a6c9df19b359");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "420793563835-9un503sig9mhain293lipqp4m2pvs11v.apps.googleusercontent.com",
                ClientSecret = "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"
            });
        }
    }
}